...
DATA = [
    {
        ...
        "Initial Action": "1. Assess ABCs - stabilize vitals.\n2. Aggressive cooling for hyperpyrexia (>41°C).\n3. Fluid resuscitation for signs of sepsis or shock.",
        "Red Flag Signs & Must-not-miss": "1. Meningitis/Encephalitis (Altered mental status, nuchal rigidity).\n2. Septic Shock (↓BP, ↑HR, mottled skin).\n3. Neutropenic Fever (Post-CTx).\n4. Infective Endocarditis (New heart murmur).\n5. Necrotizing Fasciitis (Pain out of proportion to skin findings).",
  ...
  },
  {
    ...
    "Physical Exam": "1. Full NEx: Cranial nerves, motor/sensory, coordination, gait.\n2. Meningeal Signs: Brudzinski’s and Kernig’s signs.\n3. Fundoscopy: Check for papilledema.\n4. Temporal artery palpation.",
    "Tests & Purpose": "1. Non-contrast Brain CT: r/o acute hemorrhage (Highly sensitive within 6 hours of SAH onset).\n2. Lumbar Puncture: If SAH is suspected but CT is negative, or to rule out meningitis.\n3. ESR/CRP: If Temporal Arteritis is suspected.",
